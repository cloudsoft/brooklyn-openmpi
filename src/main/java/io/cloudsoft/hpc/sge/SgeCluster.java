...
public interface SgeCluster extends DynamicCluster {
    ...
    AttributeSensor<Boolean> ALL_HOSTS_READY = Sensors.newBooleanSensor("sge.cluster.allhostsready","flag is set if all the hostnames are available and dispatched to the nodes");
