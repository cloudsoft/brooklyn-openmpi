...
public interface SgeCluster extends DynamicCluster {
    ...
    AttributeSensor<Map<Entity, String>> SGE_CLUSTER_NODES = Sensors.newSensor(new TypeToken<Map<Entity, String>>() {
    }, "sge.cluster.nodes", "Hostnames of all active SGE nodes in the cluster (public hostname/IP)");
